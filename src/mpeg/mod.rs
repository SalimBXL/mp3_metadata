...
//! La durée et le débit moyen, qui demandent d'aller chercher un éventuel
//! en-tête Xing/Info ou VBRI dans cette première frame, sont calculés à
//! part par [`AudioFormat`] (sous-module [`vbr`]) plutôt qu'ici : ce
//! module-ci ne s'occupe que de l'en-tête brut de 4 octets.
//!
...
//!
//! Voir aussi les limites propres au calcul de durée/débit, documentées
//! dans le sous-module [`vbr`].

use std::fmt;

mod vbr;
pub use vbr::AudioFormat;
